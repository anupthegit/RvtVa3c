...
namespace Etude
{
  ...
  /// </summary>
  [DataContract] public class EtudeSceneObsolete
  {
    //public class EtudeMaterialMetadata
    //{
    ...
    {
      //[DataMember] public EtudeMaterialMetadata metadata { get; set; }
    ...
    public class EtudeGeometry
    {
      ...
      [DataMember] public EtudeGeometryData data { get; set; }
      //[DataMember] public double scale { get; set; }
      [DataMember] public List<EtudeMaterial> materials { get; set; }
    }
    ...
    public class EtudeObject
    {
      ...
      [DataMember] public List<EtudeObject> children { get; set; }
    ...
    public class SceneMetadata
    {
      ...
      [DataMember] public string generator { get; set; } //  "Etude Revit Etude exporter"
    ...
    //[DataMember] public Dictionary<string, EtudeObject> objects { get; set; }
    [DataMember(Name="object")] public EtudeObject obj { get; set; }
    [DataMember] public List<EtudeGeometry> geometries;
    [DataMember] public List<EtudeMaterial> materials;
  }
}
